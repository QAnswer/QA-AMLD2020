...
title_footer.initialize=function(number,title,background){
    if (title!="-1") {
        ...
        this.background = background || 'rgb(51, 51, 51)';
        var title = title || '';
        if (title != '') {
            this.title = title;
        }
        ...
        title_footer.setAttribute('style', 'background:' + this.background + "; font-size: 30px;");
        var div_element = document.createElement('div');
        div_element.setAttribute('class', 'title');
        div_element.appendChild(document.createTextNode(this.title));
        title_footer.appendChild(div_element);
        var div_element = document.createElement('div');
        div_element.setAttribute('class', 'slideNumber');
        div_element.appendChild(document.createTextNode(number));
        title_footer.appendChild(div_element);
